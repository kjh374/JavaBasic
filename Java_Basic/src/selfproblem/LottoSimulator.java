...
//		}
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			checkLottoNumber(win, my, bonus);
			paper++;
			if(prize1==1) {
				System.out.println();
				System.out.printf("누적 당첨 횟수:\n 1등: %d, 2등: %d, 3등: %d, 4등: %d, 5등: %d, 꽝: %d \n", prize1, prize2, prize3,
						prize4, prize5, failCnt);
				System.out.println("누적 장수: " + paper + "장");
				System.out.println("누적 금액: " + paper * 1000L + "원");
				break;
			}else {
				System.out.println("로또 " + paper + "장 째 구매중...");
			}
