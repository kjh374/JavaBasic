...
public class VariableExample {
	...
	public static void main(String[] args) {
        ...
        */
		...
		// 변수의 초기화(Initialization): [변수명, area] = [값, value];
		age = 40; // = : 대입 연산자, 할당 연산자
		...
		// (처음 만들 때 한 번만 가능합니다.)
		int score = 90;
//		int score = 95; (x) 중복 선언
		
		// 변수 하나당 값을 하나밖에 대입할 수 없기 때문에
		// 기존 값이 소멸하고 새로운 값이 할당됩니다.(JavaScript도 마찬가지)
		score = 95;
		...
		// 변수의 자료형에 맞지 않는 데이터는 저장이 불가능합니다.(C언어도 마찬가지)
//		int count = "한번"; (x)
//		int count = 23.5; (x)
//		String str = 100; (x)
		
		// 변수는 자료형(데이터 타입)이 달라도 이름이 동일하다면
		// 중복 선언할 수 없습니다. (데이터 타입은 메모리에 저장되지 않는다.)
		String name = "홍길동";
//		int name = 1004; (x)
