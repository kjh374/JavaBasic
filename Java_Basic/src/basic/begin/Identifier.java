...
//		int 700 = 365; (x) 변수로 인정하지 않는다.
//		int 7number = 7; (x) 변수로 인정하지 않는다.
		int number7 = 7; 
		int num7ber = 7;
		int num12345ber = 123;
...
//		int my birth day = 19921013; (x)
		...
		int myBirthDay = 19921013; // Camel case 표기법(기본)
		int my_birth_day = 19921013; // Snake case 표기법
//		int my-birth-day = 19921013; (x) Kebab case 표기법
...
//		String class = "클래스"; (x) 
		...
		// 사용을 권장하지는 않습니다.(가독성이 떨어지고, 협업에 지장이 생기며, UTF-8이외의 실행환경에서 에러가 발생합니다.)
		int 숫자 = 10;
		String 名 = "춘식이";
